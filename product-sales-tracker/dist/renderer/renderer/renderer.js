...
let translations = {};
let isOnline = false; // Track online/offline status
// DOM Elements
let views = {};
let modals = {};
// Theme variables
    ...
    try {
        ...
        if (addSaleBtn) {
            addSaleBtn.addEventListener('click', function () {
                ...
                const saleProfitInput = document.getElementById('saleProfit');
                if (saleProductInput)
...
async function exportSalesDataCSV() {
    try {
...
async function exportSalesDataExcel() {
    try {
